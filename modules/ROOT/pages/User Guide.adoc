...
image::dpisettings.bmp[A screenshot of the DPI settings, with features numbered left-to-right.]
...
image::assignments.bmp[A screenshot of the assignments settings, with features numbered left-to-right.]
...
image::onboardmemory_window.png[]
...
image::onboardmemory_install.png[]
